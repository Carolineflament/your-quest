 ...
 */
final class Version20220309162240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE username pseudo VARCHAR(180) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE pseudo username VARCHAR(180) NOT NULL');
    }
}
